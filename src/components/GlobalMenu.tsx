...
const GlobalMenu = () => {
  ...
  const CustomToggle = React.forwardRef<HTMLDivElement, { onClick: (e: React.MouseEvent<HTMLDivElement>) => void }>(
    ({ onClick }, ref) => (
      <div ref={ref} onClick={(e) => { e.preventDefault(); onClick(e); }} style={{ fontSize: 'large', backgroundColor: '#3b3b3b', borderRadius: '35px', display: "inline-block" }}    >
    ...
    <>
      <Dropdown style={{ display: "inline-block" }} className="mx-2">
        ...
        <Dropdown.Menu>
          ...
          <Dropdown.Item as="button"><a style={{ color: 'inherit' }} href="https://ko-fi.com/neum4nn" target="_blank"><FontAwesomeIcon icon={['fas', 'heart']} color="red" size="lg" /> Support me on Ko-fi</a></Dropdown.Item>
